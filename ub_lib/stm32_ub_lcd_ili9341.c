...
//                 Chip-Select an PC2 
//
// The external SDRAM is used as video RAM
//--------------------------------------------------------------
...
//--------------------------------------------------------------
// Provides both layers to "Full Screen Mode"
//--------------------------------------------------------------
...
// and displays the respective other Layer
//--------------------------------------------------------------
...
//--------------------------------------------------------------
// Init all IO pins for the display
//--------------------------------------------------------------
void P_LCD9341_InitIO(void)
{
...
//--------------------------------------------------------------
// Init from LTCD for the display
//--------------------------------------------------------------
void P_LCD9341_InitLTCD(void)
{
...
//--------------------------------------------------------------
// initializes the ILI9341 controller in the display
//--------------------------------------------------------------
void P_LCD9341_InitChip(void)
{
	P_LCD9341_CMD(0xCA);
...
//--------------------------------------------------------------
// Send command via SPI to display
//--------------------------------------------------------------
void P_LCD9341_CMD(uint8_t wert)
{
	// Command
...
//--------------------------------------------------------------
// Send data via SPI to display
//--------------------------------------------------------------
void P_LCD9341_DATA(uint8_t value)
{
	// Data
